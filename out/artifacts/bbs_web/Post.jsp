...
<div class="center-block">
    <%
        ...
        ArrayList<Post> posts = postService.listByBlockId(Integer.parseInt(request.getParameter("blockId")));
                ...
                <tr id=${post.id}>
                    ...
                    <td>
                        <button type="button" class="btn btn-info btn-sm" style="display: inline"
                                onclick="window.location.href=('reply?postId='+$(this).parent().parent().attr('id')+'&blockId='+blockId)">
                            进入
                        </button>
                    </td>
                    <td>
        ...
        <div class="modal-content">
            ...
            <form id="form-add" class="container-fluid">
                <div class="form-group">
                    <label for="add-name">标题</label>
                    <input type="text" class="form-control name" id="add-name" name="title" placeholder="板块名">
                </div>
                <div class="form-group">
                    <label for="add-name">内容</label>
                    <input type="text" class="form-control name" id="add-content" name="content" placeholder="板块名">
                </div>
    ...
    $('#modal-change').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-btn').on("click", function () {
            $.ajax({ //TODO:点击修改后禁用输入框
                url: "post",
                type: "post",
                data: $("#form-change").serialize() + "&id=" + id + "&blockId=" + blockId,
